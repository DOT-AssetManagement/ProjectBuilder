...
namespace PBLogicTest
{
    ...
    public class DataTest
    {
        ...
        private string _ConnectionString = @"Server=XPS8960;Database=SPP_PBv1;Trusted_Connection=True;MultipleActiveResultSets=True";
        ...
        public void TestCreateNewScenario()
        {
            ...
            bool ok = DataManager.CreateNewScenario(_ConnectionString, "67940CF9-7689-4ABA-8DED-349D0A5782D1",  "Scenario_(BAMS/PAMS all districts)_20230615", 2020, 2034, 1, out int newScenId, out string errorMessage);
            Assert.IsTrue(ok, errorMessage);
        ...
        [TestMethod]
        public void THE_TestImportBAMSTreatmentsFromScratch()
        {
        ...
        [TestMethod]
        public void THE_TestImportPAMSTreatmentsFromScratch()
        {
            bool ok = ExcelWrapper.ExcelHandler.ImportTreatments(_ConnectionString,
                "PAMS", "P",
        ...
        [TestMethod]
        public void THE_TestImportBAMSTreatmentsToLibraryFromScratch()
        {
        ...
        [TestMethod]
        public void THE_TestImportPAMSTreatmentsToLibraryFromScratch()
        {
            Guid targetLibraryId =  Guid.Parse("67940CF9-7689-4ABA-8DED-349D0A5782D1");
            bool ok = ExcelWrapper.ExcelHandler.ImportTreatments(_ConnectionString,
                "PAMS", "P",
        ...
        {
            ExcelWrapper.ExcelHandler.Log = Log;
            string path = @"C:\Projects\FHWA-SpyPond\PennDOT-2022\PBJ_TREATMENTS_TO_BAMS_SCEN_8_20231031.xlsx";
        ...
        {
            ExcelWrapper.ExcelHandler.Log = Log;
            string path = @"C:\Projects\FHWA-SpyPond\PennDOT-2022\PBJ_TREATMENTS_TO_PAMS_SCEN_7_20231031.xlsx";
            bool ok = ExcelWrapper.ExcelHandler.ExportTreatmentsToPAMS(_ConnectionString, path, 7, out long recordsWritten, out string errorMessage);
            Assert.IsTrue(ok, errorMessage);
        }
        ...
        {
            ExcelWrapper.ExcelHandler.Log = Log;
            string path = @"C:\Projects\FHWA-SpyPond\PennDOT-2022\PBJ_PROJECTS_TO_PAMS_SCEN_7_20230615.xlsx";
            bool ok = ExcelWrapper.ExcelHandler.ExportProjectsToPAMS(_ConnectionString, path, 7, out long recordsWritten, out string errorMessage);
            Assert.IsTrue(ok, errorMessage);
        }
        #endregion
