...
namespace PBLogicTest
{
    ...
    public class MixedLogicText
    {
        ...
        [TestMethod]
        public void THE_TestExtendedOptimization()
        {
           
             bool  ok = SymphonyConductor.RunExtendedScenario(_ConnectionString, _homeDirectory, 8,
                    ...
                    , 2 ,false, out string errorMessage);
